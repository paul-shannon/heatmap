...
require(['underscore', 'jquery',  'clustergrammer'], function (_, $, clustergrammer) {
    ...
    make_clust(demoBioMatrix2); // options: demo3x3, demoUSArrestsSmall (is 3x4), demoUSArrests (full data set), demoBioMatrix, demoBioMatrix2 CHANGE THIS TO CHANGE CLUSTERGRAMMER
